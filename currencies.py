...
class Currency(int, Enum):
    ...
    COU = 970 # Unidad de Valor Real (UVR) (funds code)[6]
    ...
    SLE = 925 # Sierra Leonean leone (new leone)[12][13][14]
    SLL = 694 # Sierra Leonean leone (old leone)[12][13][14][15]
    ...
    UYW = 927 # Unidad previsional[17]
    UZS = 860 # Uzbekistan sum
    VED = 926 # Venezuelan digital bolívar[18]
    VES = 928 # Venezuelan sovereign bolívar[10]
    ...
    ZWL = 932 # Zimbabwean dollar (fifth)[e]
